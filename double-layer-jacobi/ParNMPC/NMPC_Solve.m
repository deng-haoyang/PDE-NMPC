function [solution,output] = NMPC_Solve(x0,p,options)
    ...
    persistent lambdaInit muInit uInit xInit zInit;
    ...
    for iter=1:options.maxIterTotal
        ...
        xSplit_k      = xSplit;
        %% Search direction
        [lambdaSplit,muSplit,uSplit,xSplit,zSplit,KKTError,costL,tSearchDirection] = ...
            NMPC_Solve_SearchDirection(x0,pSplit,rho,lambdaSplit,muSplit,uSplit,xSplit,zSplit);
