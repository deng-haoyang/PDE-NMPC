function codeGen(OCP)
    % 
    if OCP.dim.x + OCP.dim.u < OCP.THRESHOLD_DIM_UX
        isOptimize = true;
    else
        isOptimize = false;
    end
    ...
    matlabFunction(LBarrier,LBarrieru,LBarrierx,...
        ...
        'Vars',UXP,...
        'Outputs',{'LB','LBu','LBx'},'Optimize',isOptimize);
    matlabFunction(LBarrier,...
        'File','./funcgen/OCP_GEN_LB',...
        'Vars',UXP,...
        'Outputs',{'LB'},'Optimize',isOptimize);
    %% G
    matlabFunction(OCP.G,...
    'File','./funcgen/OCP_GEN_G',...
    'Vars',UXP,...
    'Outputs',{'G'},'Optimize',isOptimize);
    %% L, Lu, Lx
    ...
    matlabFunction(OCP.L,Lu,Lx,...
        ...
        'Vars',UXP,...
        'Outputs',{'L','Lu','Lx'},'Optimize',isOptimize);
    matlabFunction(OCP.L,...
    'File','./funcgen/OCP_GEN_L',...
    'Vars',UXP,...
    'Outputs',{'L'},'Optimize',isOptimize);
    %% C, Cu, Cx
    parIdx = sym('parIdx');
    ...
    if isa(OCP.C,'char')
        ...
        'Vars',UXPParIdx,...
        'Outputs',{'C','Cu','Cx'},'Optimize',isOptimize);
        matlabFunction(OCP.C,...
        'File','./funcgen/OCP_GEN_C',...
        'Vars',UXPParIdx,...
        'Outputs',{'C'},'Optimize',isOptimize);
    end
    ...
    if isa(OCP.f,'char')
        ...
        matlabFunction(fdt,fudt,fxdt,...
            ...
            'Vars',UXPParIdx,...
            'Outputs',{'fdt','fudt','fxdt'},'Optimize',isOptimize);
        matlabFunction(fdt,...
            'File','./funcgen/OCP_GEN_fdt',...
            'Vars',UXPParIdx,...
            'Outputs',{'fdt'},'Optimize',isOptimize);
    end
    ...
    if OCP.isMEnabled
        ...
        matlabFunction(MxSymfun,...
            ...
            'Vars',UXP,...
            'Outputs',{'Mx'},'Optimize',isOptimize);
        % Mu
        ...
        matlabFunction(MuSymfun,...
            ...
            'Vars',UXP,...
            'Outputs',{'Mu'},'Optimize',isOptimize);
    end
    disp('Done!');
end